...
{  
	...
	interface NYTPhotoCaptionViewLayoutWidthHinting
	{
		...
		nfloat PreferredMaxLayoutWidth();
	}
	...
	interface NYTPhotoCaptionView : NYTPhotoCaptionViewLayoutWidthHinting
	{
	...
	interface NYTPhotosViewControllerDelegate
	{
		...
		void WillDismiss (NYTPhotosViewController photosViewController);
		...
		void DidDismiss (NYTPhotosViewController photosViewController);
		...
		[return: NullAllowed]
		string TitleForPhoto (NYTPhotosViewController photosViewController, NYTPhoto photo, nuint photoIndex, nuint totalPhotoCount);
